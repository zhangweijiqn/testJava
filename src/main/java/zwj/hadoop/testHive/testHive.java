...
//        Statement stmt = null;    // 可以直接使用Statement
        HiveStatement  stmt=null;   // 这里使用HiveStatement
        try {
            conn = getConn();
            ...
            // 获取hive执行日志，只有HiveStatement才能调用QueryLog
            stmt.getQueryLog(); //可以设置每隔1s读取一次
